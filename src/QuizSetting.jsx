...
function QuizSetting({ onBack }) {
  ...
  return (
    ...
    <div className="relative bg-blue-200 bg-opacity-90 p-8 rounded-2xl w-full max-w-lg flex flex-col items-center space-y-8 text-center shadow-md">
      ...
      {/* Quizo Title */}
      <h1 style={{ fontFamily: "'Bungee Shade', cursive" }} className="text-6xl text-blue-950 font-extrabold drop-shadow-md">
        Quizo
      </h1>
      ...
      <div className="w-full flex flex-col items-center space-y-4">
        ...
        <label className="text-lg font-semibold">
          Difficulty:
          <select value={difficulty} onChange={(e) => setDifficulty(e.target.value)} className="ml-2 px-2 py-1 border rounded">
            <option value="">Any</option>
  ...
  <button className="w-full md:w-44 px-6 py-3 text-black text-lg font-bold uppercase rounded-lg transition duration-300 bg-green-500 hover:bg-green-600">
    Play
  </button>
  <button 
    onClick={onBack} 
